        ...
        <aside className="detail__side">
          <div className="detail__actions">
            {entry.active.installed ? (
              ...
              /* Not an install button: there is no store to install from,
                 and the handler behind it throws. What the user needs is to
                 be told the program moved, and the path it used to be at. */
              <button
                type="button"
                className="button"
                disabled
